...
<div class="row content">
	...
	<div class="col-md-10 col-sm-9 col-xs-9 borderCenter">
       ...
       <form class="form form-horizontal" role="form" action="ThemNhanVienServlet" method="post" id="ThemNhanVienForm">
       <div style="text-align: center; color: red;">
		  	<span id="thongbao"></span>
		  	<br/>
		  	<%
		  		String loi = (request.getAttribute("loi") != null) ? (String) request.getAttribute("loi") : ""; 
		  		String themnhanvienthanhcong = (request.getAttribute("themnhanvienthanhcong") != null) ? (String) request.getAttribute("themnhanvienthanhcong") : "";
		  	%>
		  	<%= loi %>
		  	<span style="color: green"><%= themnhanvienthanhcong %></span>
		  </div>
		<table border="0px" width= "60%" style="margin-left: 20%" >
			<tr>
				<th>Tên nhân viên <span style="color: red; margin-left: 5px;">*</span></th>
				<th><input type="text" name="TenNV" class="input_form"/><th>
			</tr>
			<tr>
			...
			<tr>
				...
				<th><input type="text" name="ChucVu" class="input_form"/></th>
			</tr>
			<tr>
				<th>Địa chỉ<span style="color: red; margin-left: 5px;">*</span></th>
				<th><input type="text" name="DiaChi" class="input_form"/></th>
			</tr>
			<tr>
				<th>Số điện thoại<span style="color: red; margin-left: 5px;">*</span></th>
				<th><input type="text" name="SDT" class="input_form"/></th>
			</tr>
			<tr>
				<th></th>
				<th>
					<input type="reset" name="nhapLai" value="Nhập lại" class="input_form"/>
					<input type="submit" name="themNV" value="Thêm mới" />
				</th>
			</tr>
		  </table>
		</form> 
